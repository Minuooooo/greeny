...
public class SuccessMessage {
    ...
    public static final String SUCCESS_TO_CANCEL_WISHLIST = "회원의 찜 목록에서 삭제하는데 성공했습니다.";
    public static final String SUCCESS_TO_GET_STORE_WISHLIST = "회원의 찜한 스토어 목록을 불러오는데 성공했습니다.";
    public static final String SUCCESS_TO_GET_PRODUCT_WISHLIST = "회원의 찜한 제품 목록을 불러오는데 성공했습니다.";
    ...
    public static final String SUCCESS_TO_TOGGLE_WISHLIST = "찜하기 or 취소에 성공했습니다.";
    ...
    public static final String SUCCESS_TO_CREATE_POST_LIKE = "게시글 좋아요 추가에 성공했습니다.";
    public static final String SUCCESS_TO_CANCEL_POST_LIKE = "게시글 좋아요 취소에 성공했습니다.";
    ...
    public static final String SUCCESS_TO_WRITE_STORE_REVIEW_FILE = "스토어 리뷰에 파일을 첨부하는데 성공했습니다.";
    ...
    public static final String SUCCESS_TO_WRITE_PRODUCT_REVIEW_FILE = "제품 리뷰에 파일을 첨부하는데 성공했습니다.";
